...
uint8_t wuclass_threshold_properties[] = {
  WKPF_PROPERTY_TYPE_SHORT+WKPF_PROPERTY_ACCESS_RW, // WKPF_PROPERTY_THRESHOLD_OPERATOR
  WKPF_PROPERTY_TYPE_SHORT+WKPF_PROPERTY_ACCESS_RW, // WKPF_PROPERTY_THRESHOLD_THRESHOLD
  WKPF_PROPERTY_TYPE_SHORT+WKPF_PROPERTY_ACCESS_RW, // WKPF_PROPERTY_THRESHOLD_VALUE
