...
public class {{ applicationName }} {
    ...
    {%- for instance in sorted(wuObjects.values(), key=lambda object: object.getInstanceIndex()) %}
    ...
    */
    ...
    private final static byte[] componentInstanceToWuObjectAddrMap = {
        {%- for wuobject in sorted(wuObjects.values(), key=lambda object: object.getInstanceIndex()) %}
