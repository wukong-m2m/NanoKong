...
#define NATIVE_METHOD_SETINTRMODE   5
#define NATIVE_METHOD_SELECT        6
#define NATIVE_METHOD_SLEEP     7
...
#define NATIVE_WKPF_METHOD_GETERRORCODE                   1
#define NATIVE_WKPF_METHOD_REGISTER_PROFILE               2
#define NATIVE_WKPF_METHOD_CREATE_ENDPOINT                3
#define NATIVE_WKPF_METHOD_REMOVE_ENDPOINT                4
#define NATIVE_WKPF_METHOD_GETPROPERTYSHORT               5
#define NATIVE_WKPF_METHOD_SETPROPERTYSHORT               6
#define NATIVE_WKPF_METHOD_GETPROPERTYBOOLEAN             7
#define NATIVE_WKPF_METHOD_SETPROPERTYBOOLEAN             8
#define NATIVE_WKPF_METHOD_SETPROPERTYSHORT_REMOTE        9
#define NATIVE_WKPF_METHOD_SETPROPERTYBOOLEAN_REMOTE     10
#define NATIVE_WKPF_METHOD_SELECT                        11
#define NATIVE_WKPF_METHOD_GETMYNODEID                   12
#define NATIVE_WKPF_METHOD_LOADNEXTDIRTYPROPERTY         13
#define NATIVE_WKPF_METHOD_GETDIRTYPROPERTYPORTNUMBER    14
#define NATIVE_WKPF_METHOD_GETDIRTYPROPERTYNUMBER        15
#define NATIVE_WKPF_METHOD_GETDIRTYPROPERTYSHORTVALUE    16
#define NATIVE_WKPF_METHOD_GETDIRTYPROPERTYBOOLEANVALUE  17
