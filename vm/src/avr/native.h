...
#define NATIVE_METHOD_GETERRORCODE          1
#define NATIVE_METHOD_REGISTER_PROFILE      2
#define NATIVE_METHOD_CREATE_ENDPOINT       3
#define NATIVE_METHOD_REMOVE_ENDPOINT       4
#define NATIVE_METHOD_GETPROPERTYSHORT      5
#define NATIVE_METHOD_SETPROPERTYSHORT      6
#define NATIVE_METHOD_GETPROPERTYBOOLEAN    7
#define NATIVE_METHOD_SETPROPERTYBOOLEAN    8
