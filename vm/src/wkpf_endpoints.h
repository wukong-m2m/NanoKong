...
extern uint8_t wkpf_get_endpoint_port(uint8_t port_number, wkpf_local_endpoint **endpoint);
extern uint8_t wkpf_get_endpoint_index(uint8_t index, wkpf_local_endpoint **endpoint);
