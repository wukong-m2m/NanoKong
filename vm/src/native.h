...
#define NATIVE_WKPF_METHOD_LOAD_COMPONENT_MAP                  15
#define NATIVE_WKPF_METHOD_LOAD_LINK_DEFINITIONS               16
#define NATIVE_WKPF_METHOD_GET_PORT_NUMBER_FOR_COMPONENT       17
#define NATIVE_WKPF_METHOD_IS_LOCAL_COMPONENT                  18
