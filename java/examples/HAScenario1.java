...
public class HAScenario1 {
  ...
  public static void main(String[] args) {
    ...
    if (isLocalComponent(COMPONENT_INSTANCE_ID_LIGHTSENSOR1)) { 
      ...
      WKPF.setPropertyRefreshRate(COMPONENT_INSTANCE_ID_LIGHTSENSOR1, WKPF.PROPERTY_LIGHT_SENSOR_SAMPLING_RATE, (short)1000); // Sample the temperature every 5 seconds
    }
