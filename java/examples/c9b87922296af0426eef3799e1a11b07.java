...
public class c9b87922296af0426eef3799e1a11b07 {
    ...
    */
    ...
    public static void main (String[] args) {
        System.out.println("c9b87922296af0426eef3799e1a11b07");
    ...
    private static void initialiseLocalWuObjects() {
        ...
        // Native WuClasses (C)
        WKPF.createWuObject((short)WKPF.WUCLASS_LIGHT_SENSOR, WKPF.getPortNumberForComponent((short)0), null);WKPF.setPropertyRefreshRate((short)0, WKPF.PROPERTY_LIGHT_SENSOR_REFRESH_RATE, (short)3000);}
        //all WuClasses from the same group has the same instanceIndex and wuclass
        if (WKPF.isLocalComponent((short)1)) {

        // Native WuClasses (C)
        WKPF.createWuObject((short)WKPF.WUCLASS_THRESHOLD, WKPF.getPortNumberForComponent((short)1), null);WKPF.setPropertyShort((short)1, WKPF.PROPERTY_THRESHOLD_OPERATOR, WKPF.ENUM_THRESHOLD_OPERATOR_LT);WKPF.setPropertyShort((short)1, WKPF.PROPERTY_THRESHOLD_THRESHOLD, (short)30);WKPF.setPropertyShort((short)1, WKPF.PROPERTY_THRESHOLD_VALUE, (short)20);WKPF.setPropertyBoolean((short)1, WKPF.PROPERTY_THRESHOLD_OUTPUT, false);}
        //all WuClasses from the same group has the same instanceIndex and wuclass
