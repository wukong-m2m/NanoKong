...
public class HAScenario2 {
  ...
  private static void initialiseLocalWuObjects() {
    ...
    if (WKPF.isLocalComponent(COMPONENT_INSTANCE_ID_THRESHOLD1)) {
      ...
      WKPF.setPropertyShort(COMPONENT_INSTANCE_ID_THRESHOLD1, WKPF.PROPERTY_THRESHOLD_OPERATOR, WKPF.ENUM_THRESHOLD_OPERATOR_LTE); // Threshold operator: <=
    }
    ...
    if (WKPF.isLocalComponent(COMPONENT_INSTANCE_ID_OCCUPANCY1)) {
      ...
      WKPF.createWuObject((short)WKPF.WUCLASS_OCCUPANCY_SENSOR, WKPF.getPortNumberForComponent(COMPONENT_INSTANCE_ID_OCCUPANCY1), wuclassInstanceOccupancy);
      WKPF.setPropertyBoolean(COMPONENT_INSTANCE_ID_OCCUPANCY1, WKPF.PROPERTY_OCCUPANCY_SENSOR_OCCUPIED, true); // Default: occupied
    }
