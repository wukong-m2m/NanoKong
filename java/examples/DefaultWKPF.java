...
public class DefaultWKPF {
  ...
  public static void main(String[] args) {
    ...
    WKPF.createWuObject((short)WKPF.WUCLASS_TEMPERATURE_HUMIDITY_SENSOR, (byte)0x27, null); 
    WKPF.setPropertyRefreshRate(WKPF.WUCLASS_TEMPERATURE_HUMIDITY_SENSOR, WKPF.PROPERTY_TEMPERATURE_HUMIDITY_SENSOR_REFRESH_RATE, (short)12);    
